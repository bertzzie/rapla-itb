...
public class ServerTest extends ServletTestBase {
    ...
    public void testRemoveCategoryBug5() throws Exception {
        DynamicType type = facade1.newDynamicType( DynamicTypeAnnotations.VALUE_RESOURCE_CLASSIFICATION);
        ...
        try {
            ...
            assertTrue("Dependencies doesnt contain " + testTypeName, contains(dependencies,testTypeName));
    ...
    public void testStoreFilter() throws Exception {
    	...
    	RaplaMap<RaplaObject> selected = facade1.newRaplaMap( new HashMap<String,RaplaObject>() );
    	CalendarModelConfiguration conf = facade1.newRaplaCalendarModel(selected, filter,null,null,null, null, facade1.today(), "week", null );
    ...
    public void testReservationInTheFutureStoredInCalendar() throws Exception{
        ...
        RaplaMap<Reservation> map = facade1.newRaplaMap( Collections.singletonList( r ));
        CalendarModelConfiguration conf = facade1.newRaplaCalendarModel( map, null,null,"test", null, null,facade1.today(), WeekViewFactory.WEEK_VIEW, null);
    ...
    public void testRestrictionsBug7() throws Exception 
    {
        ...
        Appointment app2;
        {
            Date start = getRaplaLocale().toDate( 2008, 10, 10);
            Date end = getRaplaLocale().toDate( 2008, 10, 15);
