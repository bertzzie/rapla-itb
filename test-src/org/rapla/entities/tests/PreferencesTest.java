...
public class PreferencesTest extends RaplaTestCase {
    ...
    public void testLoad() throws Exception {
        ...
        Configuration config = ((RaplaConfiguration)preferences.getEntry("org.rapla.SessionTest")).getConfig();
        assertEquals("testvalue",config.getAttribute("test"));
    }

    public void testStore() throws Exception {
        Preferences preferences = queryMod.getPreferences();
        Preferences clone = (Preferences) modificationMod.edit(preferences);
