...
public class CategoryTest extends RaplaTestCase {
    ...
    public void testStore2() throws Exception {
        Category superCategory = (Category)modificationMod.edit(queryMod.getSuperCategory());
        
        superCategory.addCategory(areas);
        modificationMod.store(superCategory);
        assertTrue(areas.getId() != null);
        Category editObject = (Category) modificationMod.edit(superCategory);
    ...
    public void testStore3() throws Exception {
        ...
        Category department = (Category) modificationMod.edit( superCategory.getCategory("department") );
        ...
        school = (Category) 
            modificationMod.edit( superCategory.getCategory("department").getCategory("channel-6") );
    ...
    public void testEditDeleted() throws Exception {
        ...
        modificationMod.store( department );
        try {
           subDepartment = (Category) modificationMod.edit( subDepartment );
