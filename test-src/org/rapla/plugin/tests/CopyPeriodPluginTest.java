...
import org.rapla.plugin.periodcopy.CopyPluginInit;
...
public class CopyPeriodPluginTest extends RaplaTestCase {
    ...
    public void test() throws Exception {
        CalendarSelectionModel model = new CalendarModelImpl( getClientService().getContext(),facade.getUser());
        ...
        CopyPluginInit init = new CopyPluginInit( getClientService().getContext() );
