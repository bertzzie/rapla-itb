...
public class NotificationPluginTest extends ServletTestBase
{
    ...
    private void add( Allocatable allocatable,         Preferences preferences ) throws ConfigurationException, RaplaException
    {
      Preferences copy = (Preferences) facade1.edit( preferences );
        RaplaMap<Allocatable> raplaEntityList =  copy.getEntry( NotificationService.ALLOCATIONLISTENERS_CONFIG );
        ...
        copy.putEntry( NotificationService.ALLOCATIONLISTENERS_CONFIG, facade1.newRaplaMap( list ) );
        copy.putEntry( NotificationService.NOTIFY_IF_OWNER_CONFIG, String.valueOf( true ) );
        facade1.store( copy );
    }
