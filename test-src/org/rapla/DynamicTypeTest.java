   ...
   public void testAttributeChange() throws Exception
    {
    	...
    	{
	    	CalendarSelectionModel model = (CalendarSelectionModel) getClientService().getContext().lookup(CalendarSelectionModel.class.getName());
    	...
    	LogManagerAdapter logManager= (LogManagerAdapter)getContext().lookup("logger-manager");
