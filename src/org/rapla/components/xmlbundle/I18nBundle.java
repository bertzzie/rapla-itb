...
public interface I18nBundle {
    ...
    */
    ...
    /** returns the URL of a resource, with the specified key. Use this method to directly 
     * access the Image Resources instead of creating an Icon.*/
    URL getResource(String key) throws MissingResourceException;
