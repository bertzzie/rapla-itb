...
public class PreferenceReader extends RaplaXMLReader {
    public static final String LOCALNAMEMAPENTRY = PreferenceReader.class.getPackage().getName() + ".localnameMap";
    public static final String READERMAP = PreferenceReader.class.getPackage().getName() + ".readerMap";
        ...
        throws SAXException
    {
        ...
        if (localName.equals("preferences")) {
            ...
            if ( owner == null )
            {
                ...
                if ( ownerid != null)
                {
                    preferences.setOwner((User)resolve(User.TYPE, ownerid));
                }
            } 
            else
            {
