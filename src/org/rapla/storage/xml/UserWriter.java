...
public class UserWriter extends RaplaXMLWriter {
    ...
    public void printUser(User user, boolean includePassword) throws IOException,RaplaException {
    ...
    public void printUsers()  throws IOException,RaplaException {
        ...
        Iterator<User> it = cache.getIterator(User.class);
        while (it.hasNext()) {
            printUser( it.next(), true);
        }
