...
public class DynamicTypeReader extends RaplaXMLReader
{
    ...
    HashMap<String,String> typeAnnotations = new HashMap<String,String>();
    HashMap<String,String> attributeAnnotations = new HashMap<String,String>();
        ...
        Attributes atts ) throws SAXException
    {
            ...
            AttributeImpl.DEFAULT_TYPE ))
        {
            ...
            if (type == null)
                throw createSAXParseException( "AttributeType '" + type + "' not found." );
