...
public class RaplaXMLReader extends DelegationHandler implements Namespaces
{
	...
	public RaplaXMLReader( RaplaContext context ) throws RaplaException
    {
        ...
        this.localnameMap = (Map<String,RaplaType>) context.lookup( PreferenceReader.LOCALNAMEMAPENTRY );
        this.readerMap = (Map<Object,RaplaXMLReader>) context.lookup( PreferenceReader.READERMAP );
    }
