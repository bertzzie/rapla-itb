...
<ul>
  ...
  <li>notifing subscribed clients when the stored-data has
  changed</li>
</ul>
*/
public interface ServerService extends Startable, Container {
    String ROLE = ServerService.class.getName();
