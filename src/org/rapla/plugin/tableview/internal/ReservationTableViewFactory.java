...
public class ReservationTableViewFactory extends RaplaComponent implements ViewFactory
{
    public ReservationTableViewFactory( RaplaContext context ) throws RaplaException
    {
        super( context );
    }
