...
public class AppointmentTableViewFactory extends RaplaComponent implements ViewFactory
{
    public AppointmentTableViewFactory( RaplaContext context ) throws RaplaException
    {
        super( context );
    }
