...
public class RaplaICalExport extends RaplaComponent implements ICalExport
{
        TimeZone timezone;

        public RaplaICalExport( RaplaContext context, Configuration config) throws RaplaException {
            super( context );
        ...
        public void export(String reservationIds, OutputStream out ) throws RaplaException, IOException 
        {
            ...
            converter.setiCalendarWorktime(getCalendarOptions(), getRaplaLocale());
        ...
        private Reservation getReservation(String id) throws RaplaContextException 
        {
