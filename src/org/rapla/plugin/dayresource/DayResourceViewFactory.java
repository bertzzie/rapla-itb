...
public class DayResourceViewFactory extends RaplaComponent implements ViewFactory
{
    public DayResourceViewFactory( RaplaContext context ) throws RaplaException
    {
        super( context );
    }
