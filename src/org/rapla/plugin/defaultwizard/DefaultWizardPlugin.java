...
public class DefaultWizardPlugin implements PluginDescriptor {
    ...
    public void provideServices(Container container, Configuration config) {
        ...
        container.addContainerProvidedComponent( RaplaExtensionPoints.RESERVATION_WIZARD_EXTENSION, DefaultWizard.class.getName(), PLUGIN_CLASS, config);
    }
