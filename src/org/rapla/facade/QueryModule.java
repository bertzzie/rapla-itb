...
public interface QueryModule
{
    ...
    **/
    ...
    public Collection<Allocatable> getAllocatableBindings(List<Allocatable> allocatables,Appointment forAppointment) throws RaplaException;
     ...
     * @deprecated use {@link #getAllocatableBindings(List, Appointment)} instead
     * */
    @Deprecated
    ...
    /** returns all existing conflicts that are visible for the user
        conflicts, since the passed Date. If startDate is null all
        conflicts are shown.
     * @param allocatables 
     */
    Conflict[] getConflicts(Collection<Allocatable> allocatables, Date startDate) throws RaplaException;
