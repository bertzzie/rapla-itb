     ...
     EditComponent
{
    ...
    JLabel editAdvanced = new JLabel();
    ...
    public DynamicTypeEditUI(RaplaContext sm) throws RaplaException {
        super(sm);
        final String attributeColorString = getString("attribute") + " " +  getString("color");
        
        colorChooser = new JComboBox(new String[] {getString("color.automated"),attributeColorString,getString("disabled")});
        ...
        editAdvanced.setText("* " + getString("warning.experienced_users_only"));
        ...
        editPanel.add(editAdvanced,"1,10,3,10");
        ...
        colorChooser.addActionListener(new ActionListener() {
    			...
    			public void actionPerformed(ActionEvent e) {
    				try {
    					...
    					DialogUI ui = DialogUI.create(getContext(), getMainComponent(), true, attributeColorString, getString("attribute_color_dialog"), new String[]{getString("yes"),getString("no")});
						ui.start();
						if (ui.getSelectedIndex() == 0)
						{
							...
							colorAttribute.setAnnotation(AttributeAnnotations.KEY_EDIT_VIEW, AttributeAnnotations.VALUE_NO_VIEW);
