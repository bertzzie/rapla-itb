...
public class DynamicTypeAction extends  RaplaObjectAction {
    ...
    public DynamicTypeAction(RaplaContext sm,Component parent) throws RaplaException {
        super(sm,parent);
    }
    public DynamicTypeAction(RaplaContext sm,Component parent,Point p) throws RaplaException {
        super(sm,parent,p);
    }
    ...
    protected void newEntity() throws RaplaException {
        getEditController().edit(getModification().newDynamicType(classificationType)
                                    ,parent);
    }
