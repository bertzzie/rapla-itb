...
public class PasswordChangeAction extends RaplaAction {
    ...
    public PasswordChangeAction(RaplaContext sm,Component parent,Point point) throws RaplaException {
        super( sm);
        this.parent = parent;
    ...
    public void changePassword(User user,boolean showOld) throws RaplaException{
        new PasswordChangeActionA(user,showOld);
    }
    ...
    class PasswordChangeActionA extends AbstractAction {
        ...
        PasswordChangeActionA(User user,boolean showOld) throws RaplaException{
            this.user = user;
