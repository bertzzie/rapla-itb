        ...
        ModificationListener
{
    ...
    public MainFrame(RaplaContext sm) throws RaplaException {
        ...
        String title = getQuery().getPreferences( null ).getEntryAsString(RaplaStartOption.TITLE, getString("rapla.title"));
        // CKO TODO Title should be set in config allong with the facade used
        frame.setTitle(title );
        	
        getUpdateModule().addModificationListener(this);
        CalendarSelectionModel model = (CalendarSelectionModel) getService( CalendarSelectionModel.class);
